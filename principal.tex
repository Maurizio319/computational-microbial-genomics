...
\input{chapters/EcoliGenomics}
\input{chapters/03-NGS-principles-DeSanctisFile}

\input{chapters/04sequencingAlgorithms}
\input{chapters/04_Sequencing_Data}

\input{chapters/StaphylococcusAureus}
